...
public class Server {
    ...
    public Server(long seed, ServerWorld world, ServerBlockService blockService) throws InterruptedException {
        ...
        this.script = launchGame(selected);
    ...
    private Value launchGame(String gameDirectory) {
